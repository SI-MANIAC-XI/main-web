                    ...
                    @foreach ($team->teamDetail as $item)
                        ...
                        <div class="col-lg-4 mb-3 daftar-anggota">
                           ...
                           @if ($team->status != 'accepted')
                              <div class="row m-3">
                                 <label for="imgAnggota2" class="text-center label-ganti-kp">Ganti Kartu Pelajar</label>
                                 <input type="file" accept="application/pdf,image/*" name="imgAnggota{{ $loop->index }}" id="imgAnggota2 formFileMultiple" class="myInputFile form-control @error('imgAnggota{{ $loop->index }}') is-invalid @enderror" style="color:#a0583a;">
