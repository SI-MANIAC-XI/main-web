                    ...
                    <div class="col-lg-4 mb-3 daftar-anggota">
                        ...
                        @if ($team->status != 'accepted')
                           <div class="row mt-3">
                              ...
                              <input type="file" class="myInputFile @error('{{ "imgAnggota".$loop->index }}') is-invalid @enderror" 
                              accept="application/pdf,image/*" name="{{ 'imgAnggota'.$loop->index }}" id="imgAnggota2">
                           </div>
