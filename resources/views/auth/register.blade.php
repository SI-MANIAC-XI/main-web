                    ...
                    <form action="" class="mt-5">
                        <div class="data-tim">
                            ...
                            <Label class="myLabel">Nama Tim</Label>
                                <input type="text" name="txtNamaTim" id="txtNamaTim" class="myTextbox width-90" placeholder="Nama Tim">
                            <label class="myLabel">Nama Sekolah</label>
                                <input type="text" name="txtNamaSekolah" id="txtNamaSekolah" class="myTextbox width-90" placeholder="Nama Sekolah">
                            <label class="myLabel">Alamat Lengkap Sekolah</label>
                                <textarea name="txtAlamat" id="txtAlamat" cols="30" rows="10" class="myTextbox width-90" placeholder="Alamat Lengkap cth. Jalan Raya Kalirungkut, Surabaya 60293" style="padding-top: 5px; padding-bottom: 5px; height: 80px; min-height: 40px;"></textarea>
                        ...
                        <div class="data-anggota ketua">
                            ...
                            <label class="myLabel">Nama Ketua Tim</label>
                                <input type="text" name="txtNamaKetua" id="txtNamaKetua" class="myTextbox width-90" placeholder="Nama Ketua Tim">
                            <label class="myLabel">Nomor HP</label>
                                <input type="text" name="txtNoHpKetua" id="txtNoHpKetua" class="myTextbox width-90" placeholder="Nomor HP">
                            <label class="myLabel">Email</label>
                                <input type="email" name="txtEmailKetua" id="txtEmailKetua" class="myTextbox width-90" placeholder="Email">
                            <label class="myLabel">Kartu Pelajar</label>
                                <input type="file" accept="image/*" name="KartuPelajarKetua" id="KartuPelajarKetua" class="myInputFile width-90">
                        </div>
                        ...
                        <div class="data-anggota anggota-1">
                            ...
                            <label class="myLabel">Nama Anggota 1</label>
                                <input type="text" name="txtNamaAnggota1" id="txtNamaAnggota1" class="myTextbox width-90" placeholder="Nama Anggota 1">
                            <label class="myLabel">Nomor HP</label>
                                <input type="text" name="txtNoHpAnggota1" id="txtNoHpAnggota1" class="myTextbox width-90" placeholder="Nomor HP">
                            <label class="myLabel">Email</label>
                                <input type="email" name="txtEmailAnggota1" id="txtEmailAnggota1" class="myTextbox width-90" placeholder="Email">
                            <label class="myLabel">Kartu Pelajar</label>
                                <input type="file" accept="image/*" name="KartuPelajarAnggota1" id="KartuPelajarAnggota1" class="myInputFile width-90">
                        </div>
                        ...
                        <div class="data-anggota anggota-2">
                            ...
                            <label class="myLabel">Nama Anggota 2</label>
                                <input type="text" name="txtNamaAnggota2" id="txtNamaAnggota2" class="myTextbox width-90" placeholder="Nama Anggota 2">
                            <label class="myLabel">Nomor HP</label>
                                <input type="text" name="txtNoHpAnggota2" id="txtNoHpAnggota2" class="myTextbox width-90" placeholder="Nomor HP">
                            <label class="myLabel">Email</label>
                                <input type="email" name="txtEmailAnggota2" id="txtEmailAnggota2" class="myTextbox width-90" placeholder="Email">
                            <label class="myLabel">Kartu Pelajar</label>
                                <input type="file" accept="image/*" name="KartuPelajarAnggota2" id="KartuPelajarAnggota2" class="myInputFile width-90">
                        </div>
